...
#
# - The argument ``non_graphical`` specifies whether or not an interactive
# session will be launched or if
#   AEDT runs in non-graphical mode.
# - The Boolean parameter ``new_thread`` specifies if a new instance
#   of AEDT will be launched. If it is set to ``False`` the API will
#   try to connect to a running session.
#
...
# ## Eye Diagram
#
# Create an eye diagram. the JSON file can be used to
# create an eye diagram, including the eye mask as demonsrated here.
