...
class Cable_Layer:
    def __init__(self, radius, name, material, color):
        self.radius = radius
        self.name = name
...
obj_cond_1= Cable_Layer("dia_conductor/2","cond_1","copper",(255,0,0))
obj_cond_screen_1 = Cable_Layer("dia_conductor_screen/2","cond_screen_1","copper",(255,0,0))
...
cond_ids = [m2d.modeler.create_circle(
    origin=["0mm", "0mm", "0mm"],
    radius = layer.radius,
    name = layer.name,
...
# Create layer instances
obj_filler= Cable_Layer ("dia_filler/2","filler_background","MDPE", (175,143,175))
obj_bedding = Cable_Layer("dia_bedding/2","bedding","PPY",(128,0,255))
obj_inner_sheat = Cable_Layer("dia_inner_sheath/2","inner_sheath","HDPE",(128,0,255))
obj_inner_armor = Cable_Layer("dia_armor_inner/2","inner_armor","stainless_steel",(128,0,255))
...
outer_ids = [m2d.modeler.create_circle(
    origin=["0mm", "0mm", "0mm"],
    radius = layer.radius,
    name = layer.name,
    material = layer.material,
...
m2d.modeler.create_coordinate_system(origin=["0mm", "0mm", "0mm"],
                                     mode= "axis",
...
m2d.modeler.set_working_coordinate_system("Global")
tool_ellipse = m2d.modeler.create_ellipse(origin = ["0mm","-65mm","0mm"],major_radius=60, ratio =0.55)
m2d.modeler.intersect([outer_ids[0],tool_ellipse])
m2d.modeler.subtract([outer_ids[0]],["cond_dia_conductor_sheat_1","cond_dia_conductor_sheat_1_2"])
